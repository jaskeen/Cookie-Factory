...
TruckOpening; ../Documents/iPad Project/TruckOpening.swf; (x=0, y=0); 31; 30; 30; (x=-154, y=-100); (x=154, y=94); (x=-156, y=-102, w=312, h=198); 1; false; false
assetShapes 0
]]
...
local function load()
    ...
    sheet = sprite.newSpriteSheetFromData("truckSprite2@0_5.png", {frames = allFrames })
